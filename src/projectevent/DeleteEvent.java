...
public class DeleteEvent extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String eventid=jTextField1.getText();int i=0;
         try {
            ...
            if(rs.next())
               i=JOptionPane.showConfirmDialog (null, "Event Found Click yes to Remove User Permanently ","Warning",JOptionPane.YES_NO_OPTION);
            else
                JOptionPane.showMessageDialog(null, "Event Not Exist");
            
            if(i==JOptionPane.YES_OPTION){
                String query2="DELETE FROM `eventmanagement`.`events` WHERE `idevents`='"+eventid+"';";
                Statement stmt=con.createStatement();
                stmt.execute(query2);
                String query3="DELETE FROM `eventmanagement`.`eventregistration` WHERE `eventid`='"+eventid+"';";
                stmt.execute(query3);
