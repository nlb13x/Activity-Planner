...
public class ForgetPassword extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            String query="select * from login where id_login=? and email=?";
		...
		try {
			...
			message.setText("Your Password is :-   "+rs.getString(5));

			Transport.send(message);
                        JOptionPane.showMessageDialog(null, "Check Your Registered  Mail");
           ...
           // Logger.getLogger(ForgetPassword.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "UserId or Email Incorrect");
        }
