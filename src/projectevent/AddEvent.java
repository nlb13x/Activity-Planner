...
public class AddEvent extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            eventname=jTextField2.getText();
            eventcreatedon=jTextField3.getText();
            lastdoreg=jTextField4.getText();
            eventwillbeon=jTextField5.getText();
            eventdesc=jTextField6.getText();
            venue=jTextField7.getText();
            Connection conn=DatabaseConnection.getConn();
            String query="INSERT INTO `eventmanagement`.`events` (`idevents`, `eventname`, `eventcreatedon`, `lastdateofregistraion`, `eventwillbeon`, `eventdescription`, `eventvenue`)"
                    + " VALUES ('"+eventid+"', '"+eventname+"', '"+eventcreatedon+"', '"+lastdoreg+"', '"+eventwillbeon+"', '"+eventdesc+"', '"+venue+"');";
            ...
            if( eventid==null || eventname==null || eventcreatedon==null || lastdoreg==null || eventwillbeon==null || eventdesc==null || venue==null){
